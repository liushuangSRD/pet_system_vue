  ...
  <div>
    ...
    <div class="container" v-if="!showEdit">
      ...
      <el-table :data="books" v-loading="loading">
        ...
        <el-table-column prop="measure" label="规范措施"></el-table-column>
        <el-table-column prop="validate" label="有效日期"></el-table-column>
        <el-table-column label="操作" fixed="right" width="275">
          <template #default="scope">
            ...
            <el-button
              ...
              v-permission="{ permission: '删除规范', type: 'disabled' }"
              >删除</el-button
            >
          </template>
        </el-table-column>
