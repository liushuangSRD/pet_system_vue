  ...
  <div>
    ...
    <div class="container" v-if="!showEdit">
      ...
      <el-table :data="books" v-loading="loading">
        ...
        <el-table-column prop="nature" label="宠物性格"></el-table-column>
        <el-table-column label="操作" fixed="right" width="275">
          <template #default="scope">
            ...
            <el-button
              ...
              v-permission="{ permission: '删除宠物类型', type: 'disabled' }"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
import NoteModify from './petType'
