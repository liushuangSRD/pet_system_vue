<template>
  <div>
    ...
    <div class="container" v-if="!showEdit">
      <div class="header">
        <div class="title">宠物寄养列表</div>
      </div>
      <!-- 表格 -->
      <el-table :data="books" v-loading="loading">
        <el-table-column type="index" :index="indexMethod" label="序号" width="100"></el-table-column>
        <el-table-column prop="name" label="名称"></el-table-column>
        <el-table-column prop="address" label="寄养地址"></el-table-column>
        <el-table-column prop="farmDate" label="寄养开始时间"></el-table-column>
        ...
        <el-table-column label="操作" fixed="right" width="275">
          <template #default="scope">
            ...
            <el-button
              ...
              v-permission="{ permission: '删除寄养', type: 'disabled' }"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  setup() {
    ...
    const handleDelete = id => {
      ElMessageBox.confirm('此操作将永久删除该寄养信息, 是否继续?', '提示', {
