<template>
  <div class="container">
    <div class="title" v-if="!editBookId">新建宠物健康信息{{ editBookId }}</div>
    <div class="title" v-else>
      <span>修改宠物健康信息</span> <span class="back" @click="back"> <i class="iconfont icon-fanhui"></i> 返回 </span>
    </div>
        ...
        <el-col :lg="16" :md="20" :sm="24" :xs="24">
          <el-form :model="note" status-icon ref="form" label-width="150px" @submit.prevent :rules="rules">
            ...
            <el-form-item label="宠物体重" prop="weight">
              <el-input v-model="note.weight" placeholder="请填写宠物体重"></el-input>
            </el-form-item>
            ...
            <el-form-item label="健康信息" prop="info">
              <el-input v-model="note.info" placeholder="请填写健康信息"></el-input>
            </el-form-item>
