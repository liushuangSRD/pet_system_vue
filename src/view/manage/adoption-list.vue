  ...
  <div>
    ...
    <div class="container" v-if="!showEdit">
      ...
      <el-table :data="books" v-loading="loading">
        ...
        <el-table-column prop="person" label="领养人姓名"></el-table-column>
        <el-table-column prop="phone" label="领养人手机号"></el-table-column>
        <el-table-column prop="address" label="领养人地址"></el-table-column>
...
import NoteModify from './adoption'
